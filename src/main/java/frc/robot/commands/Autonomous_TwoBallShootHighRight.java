...
public class Autonomous_TwoBallShootHighRight extends SequentialCommandGroup {
  public Autonomous_TwoBallShootHighRight(subDriveSystem _drive, subFeedSystem _feed, subIntakeSystem _intake, subPneumaticSystem _air, subShootSystem _shooter) {
    addCommands(
