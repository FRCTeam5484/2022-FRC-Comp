...
public class Autonomous_Option2 extends SequentialCommandGroup {
  public Autonomous_Option2(subDriveSystem drive, subFeedSystem feed, subIntakeSystem intake, subPneumaticSystem air, subShootSystem shooter, subLimeLightSystem lime) {
    addCommands(
      new cmdShooter_AutoShootHighGoal(drive, lime, shooter, feed, 2),  
      ...
      new ParallelCommandGroup(
        ...
        new cmdDrive_DriveStraightByEncoder(drive, 35, 0.6)
      ),
